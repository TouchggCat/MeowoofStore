...
namespace MeowoofStore.Data.Migrations
{
    ...
    public partial class PopulateDefaultUsers : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO [dbo].[Member] ([Id], [Email], [MemberName], [RoleId], [Password], [Address], [Salt], [IsEnabled]) VALUES (2, N'customer@customer.com', N'Customer_No1', 2, N'UK6HOJ3feWk3LnUY2fJzMRIPzdiMbq8+BUFEbLnQa3M=', N'100台北市中正區重慶南路一段122號', 0x61132F536987D30F1834F062A7E53E19, 1)");
        }
